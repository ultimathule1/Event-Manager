...
public class MapperConfig {
    ...
    public ModelMapper getMapper() {
        ...
        mapper.createTypeMap(EventChangerEvent.class, RetryableTaskEntity.class)
                .setConverter(ctx -> {
                    ...
                    RetryableTaskEntity task = new RetryableTaskEntity();
        ...
        mapper.createTypeMap(RetryableTaskEntity.class, EventChangerEvent.class)
                .setConverter(ctx -> {
                    RetryableTaskEntity task = ctx.getSource();
